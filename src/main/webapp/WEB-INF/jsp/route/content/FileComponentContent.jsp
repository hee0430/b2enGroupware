...
<input type="hidden" name="componentType" id="componentType" value="FILE">
...
<fieldset style="margin-top:10px;padding:10px;" class="fromEndpntSe">
	...
	<div class="col-md-12" style="padding-right:0px;">
		<div class="form-group col-md-12" style="padding-right:0px;">
			<label class="col-form-label required-item">기준 디렉토리</label>
			<input type="text" class="form-control" name="rootDrctryFrom" id="rootDrctryFrom" value="${data.rootDrctry}" maxlength="200" required="required" tabindex="1">
		</div>
	</div>
	<div class="col-md-6" style="padding-right:0px;">
		...
		<div class="form-group col-md-12" style="padding-right:0px;">
			<label class="col-form-label required-item">변경 감지 간격(ms)</label>
...
<fieldset style="margin-top:10px;padding:10px;" class="toEndpntSe">
	...
	<div class="col-md-12" style="padding-right:0px;">
		<div class="form-group col-md-12" style="padding-right:0px;">
		<label class="col-form-label required-item">기준 디렉토리</label>
		<input type="text" class="form-control" name="rootDrctryTo" id="rootDrctryTo" value="${data.rootDrctry}" required="required" maxlength="200" data-error-position="before" tabindex="1">
		</div>
	</div>
	<div class="col-md-6" style="padding-right:0px;">
		<div class="form-group col-md-12" style="padding-right:0px;">
	...
	<div class="col-md-6" style="padding-right:0px;">
		...
		<div class="form-group col-md-12 show-control-dplctProcessTy" style="padding-right:0px;display:none;">
			<label class="col-form-label required-item">디렉토리/파일명</label>
		...
		<div class="form-group col-md-12" style="padding-right:0px;">
			...
			<input type="text" class="form-control" name="comptFileNm" id="comptFileNm" placeholder="" value="${data.comptFileNm}" maxlength="100" tabindex="5">
		</div>
	</div>
</fieldset>
<fieldset style="margin-top:10px;padding:10px;" class="fromEndpntSe">
...
<fieldset style="margin-top:10px;padding:10px;" class="fromEndpntSe">
	...
	<div class="col-md-6" style="padding-right:0px;">
		<div class="form-group col-md-12 show-control-eqltyData" style="padding-right:0px;display:none;">
			<label class="col-form-label required-item">검증방식</label>
...
<fieldset style="margin-top: 10px;padding: 10px;">
	...
	<div class="col-md-6" style="padding-right:0px;">
		<div class="form-group col-md-12 show-control-fileReadTy" style="padding-right:0px;display:none;">
			<label class="col-form-label required-item">매핑키</label>
	...
	<div class="col-md-12" style="padding-right:0px;">
		<div class="form-group col-md-12 show-control-fileReadTy" style="padding-right:0px;display:none;">
			<label class="col-form-label required-item">컬럼목록</label>
	...
	<div class="col-md-12" style="padding-right:0px;">
		<div class="form-group col-md-12 show-control-fileReadTy FXLT" style="padding-right:0px;display:none;">
			<label class="col-form-label required-item">컬럼길이(byte)</label>
...
<script>
	...
	if($('#readLokIntrvl').val() == ''){
		$('#readLokIntrvl').val('500');
	}
