			...
			<div class="col-md-12 portlets">
				...
				<div class="panel">
					...
					<div class="panel-content">
						<form name="form01" id="form01" action="/statistics/transaction/month" method="post">
							...
							<div class="tab-pane fade active in" id="tab1">
								<div class="row">
										...
										<table class="table table-custom">
											...
											<tbody>
												...
												<tr>
													...
													<td><div style="width:60px;">일(day)</div></td>
												</tr>
												<tr>
													<td>건</td>
												</tr>
									...
									<div class="col-md-1" style="overflow-y:auto;width:86%;padding:0px 0px; ">
										<table class="table table-hover" style="width:1520px;">
											<thead>
												<tr>
											...
											<tbody>
												...
												<tr>
													<c:forEach var="item" items="${list}">
														<td style="text-align:right">${item.peakTrnscDe}</td>
													</c:forEach>
												</tr>
												<tr>
													<c:forEach var="item" items="${list}">
												...
												<tr>
													<c:forEach var="item" items="${list}">
														<td style="text-align:right;width:75px;">${item.peakDataDe}</td>
													</c:forEach>
												</tr>
												<tr>
													<c:forEach var="item" items="${list}">
...
function excelDownload() {
	var type= $($('.nav.nav-tabs li')[0]).hasClass('active') ? '3' : '6';
	var year = $('#year').val();
	var month = 1;
	var day = 1;
