	...
	<div class="col-md-12 portlets">
		...
		<div class="panel">
			...
			<div class="panel-content">
				<form name="form01" id="form01" action="/statistics/transaction/hour" method="post">
				...
				<div class="tab-content" style="overflow-y: auto;border-top: 0px solid #dfdfdf;">
					...
					<div class="tab-pane fade" id="tab2">
						<div class="col-md-1" style="width:18%;padding:0px 0px;overflow-x: hidden;">
							<table class="table table-custom">
								<thead>
									<tr>
...
function excelDownload() {
	var type= $($('.nav.nav-tabs li')[0]).hasClass('active') ? '1' : '4';
	var year = $('#year').val();
	var month = $('#month').val();
	var day = $('#day').val();
